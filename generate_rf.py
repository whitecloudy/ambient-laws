...
#     stop_variance=0.0, padding_mask = 1
# ):
...
#     # Main sampling loop.
#     x_next = latents.to(torch.float64) * t_steps[0] * padding_mask
...
#         x_hat = (x_cur + (t_hat ** 2 - t_cur ** 2).sqrt() * S_noise * randn_like(x_cur)) * padding_mask
