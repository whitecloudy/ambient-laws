...
@click.option('--scheduler_mode',    help='Scheduler mode for edm_with_scheduler', metavar='using_sigma_t_n|no_sigma_t_n|no_nn_scheduler|using_sigma_t_n_wo_z|no_nn_scheduler_with_z', type=click.Choice(['using_sigma_t_n', 'no_sigma_t_n', 'no_nn_scheduler', 'using_sigma_t_n_wo_z', 'no_nn_scheduler_with_z']), default='using_sigma_t_n', show_default=True)
...
def main(**kwargs):
    ...
    if opts.real_precond == 'edm':
        ...
        if opts.scheduler_mode in ['using_sigma_t_n', 'no_sigma_t_n', 'no_nn_scheduler_with_z']:
